...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="sidebar">
                <ul class="nav flex-column nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'dashboard_pegawai.php' ? 'active' : ''; ?>"
                            href="dashboard_pegawai.php">
        ...
        <div class="col-md-9 ml-sm-auto col-lg-9 px-md-4 content">
            <!-- Isi halaman Anda -->
            <h1>Selamat datang di Inventaris Kantor</h1>
            <p>Ini adalah halaman konten.</p>
            <p>Ini dashboard pegawai biasa<P>
            </div>
            <!-- Akhir Konten Utama -->
        </div>
    </div>
